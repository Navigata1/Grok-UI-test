...
8. Pick the final title and the final A/B pair. Solo: do this the next morning, not now; the 12-hour gap is the second reviewer. Put the title in: `npm run booster -- package build <slug> --title "<final title>"`. Every rebuild keeps it, the workflow's packaging stage included.
